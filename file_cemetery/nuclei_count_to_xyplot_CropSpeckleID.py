...
cppipe_path = base_dir / "CropSpeckleID.cppipe"
...
upper_vehicle_mean = df[df['FileName_DNA'].isin(upper_vehicle_wells)]['Count_Nuclei'].mean()
...
upper_dose1_mean = df[df['FileName_DNA'].isin(upper_dose1_wells)]['Count_Nuclei'].mean()
...
upper_dose2_mean = df[df['FileName_DNA'].isin(upper_dose2_wells)]['Count_Nuclei'].mean()
...
upper_dose3_mean = df[df['FileName_DNA'].isin(upper_dose3_wells)]['Count_Nuclei'].mean()
...
upper_dose4_mean = df[df['FileName_DNA'].isin(upper_dose4_wells)]['Count_Nuclei'].mean()
...
upper_dose5_mean = df[df['FileName_DNA'].isin(upper_dose5_wells)]['Count_Nuclei'].mean()
...
upper_dose6_mean = df[df['FileName_DNA'].isin(upper_dose6_wells)]['Count_Nuclei'].mean()
...
upper_dose7_mean = df[df['FileName_DNA'].isin(upper_dose7_wells)]['Count_Nuclei'].mean()
...
upper_dose8_mean = df[df['FileName_DNA'].isin(upper_dose8_wells)]['Count_Nuclei'].mean()
...
upper_dose9_mean = df[df['FileName_DNA'].isin(upper_dose9_wells)]['Count_Nuclei'].mean()
...
lower_vehicle_mean = df[df['FileName_DNA'].isin(lower_vehicle_wells)]['Count_Nuclei'].mean()
...
lower_dose1_mean = df[df['FileName_DNA'].isin(lower_dose1_wells)]['Count_Nuclei'].mean()
...
lower_dose2_mean = df[df['FileName_DNA'].isin(lower_dose2_wells)]['Count_Nuclei'].mean()
...
lower_dose3_mean = df[df['FileName_DNA'].isin(lower_dose3_wells)]['Count_Nuclei'].mean()
...
lower_dose4_mean = df[df['FileName_DNA'].isin(lower_dose4_wells)]['Count_Nuclei'].mean()
...
lower_dose5_mean = df[df['FileName_DNA'].isin(lower_dose5_wells)]['Count_Nuclei'].mean()
...
lower_dose6_mean = df[df['FileName_DNA'].isin(lower_dose6_wells)]['Count_Nuclei'].mean()
...
lower_dose7_mean = df[df['FileName_DNA'].isin(lower_dose7_wells)]['Count_Nuclei'].mean()
...
lower_dose8_mean = df[df['FileName_DNA'].isin(lower_dose8_wells)]['Count_Nuclei'].mean()
...
lower_dose9_mean = df[df['FileName_DNA'].isin(lower_dose9_wells)]['Count_Nuclei'].mean()
...
normalized_upper_wells = [[df[df['FileName_DNA'] == well]['Count_Nuclei'].mean() / upper_vehicle_mean for well in condition] for condition in upper_conditions]
normalized_lower_wells = [[df[df['FileName_DNA'] == well]['Count_Nuclei'].mean() / lower_vehicle_mean for well in condition] for condition in lower_conditions]
