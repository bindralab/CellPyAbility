...
image_dir_button = ttk.Button(
    root, text="Select Image Directory", command=select_image_dir
)
...
try:
    ...
    raise FileNotFoundError(
        "CellProfiler not found. Please select the correct path in Pipeline options."
    )
...
upper_vehicle_wells = [
    "B2_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "C2_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "D2_-1_1_1_Stitched[DAPI 377,447]_001.tif",
]
upper_vehicle_mean = df[df["FileName_images"].isin(upper_vehicle_wells)][
    "Count_nuclei"
].mean()

upper_dose1_wells = [
    "B3_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "C3_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "D3_-1_1_1_Stitched[DAPI 377,447]_001.tif",
]
upper_dose1_mean = df[df["FileName_images"].isin(upper_dose1_wells)][
    "Count_nuclei"
].mean()

upper_dose2_wells = [
    "B4_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "C4_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "D4_-1_1_1_Stitched[DAPI 377,447]_001.tif",
]
upper_dose2_mean = df[df["FileName_images"].isin(upper_dose2_wells)][
    "Count_nuclei"
].mean()

upper_dose3_wells = [
    "B5_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "C5_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "D5_-1_1_1_Stitched[DAPI 377,447]_001.tif",
]
upper_dose3_mean = df[df["FileName_images"].isin(upper_dose3_wells)][
    "Count_nuclei"
].mean()

upper_dose4_wells = [
    "B6_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "C6_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "D6_-1_1_1_Stitched[DAPI 377,447]_001.tif",
]
upper_dose4_mean = df[df["FileName_images"].isin(upper_dose4_wells)][
    "Count_nuclei"
].mean()

upper_dose5_wells = [
    "B7_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "C7_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "D7_-1_1_1_Stitched[DAPI 377,447]_001.tif",
]
upper_dose5_mean = df[df["FileName_images"].isin(upper_dose5_wells)][
    "Count_nuclei"
].mean()

upper_dose6_wells = [
    "B8_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "C8_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "D8_-1_1_1_Stitched[DAPI 377,447]_001.tif",
]
upper_dose6_mean = df[df["FileName_images"].isin(upper_dose6_wells)][
    "Count_nuclei"
].mean()

upper_dose7_wells = [
    "B9_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "C9_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "D9_-1_1_1_Stitched[DAPI 377,447]_001.tif",
]
upper_dose7_mean = df[df["FileName_images"].isin(upper_dose7_wells)][
    "Count_nuclei"
].mean()

upper_dose8_wells = [
    "B10_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "C10_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "D10_-1_1_1_Stitched[DAPI 377,447]_001.tif",
]
upper_dose8_mean = df[df["FileName_images"].isin(upper_dose8_wells)][
    "Count_nuclei"
].mean()

upper_dose9_wells = [
    "B11_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "C11_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "D11_-1_1_1_Stitched[DAPI 377,447]_001.tif",
]
upper_dose9_mean = df[df["FileName_images"].isin(upper_dose9_wells)][
    "Count_nuclei"
].mean()

# Calculate the average Count_nuclei per condition for the lower three rows
lower_vehicle_wells = [
    "E2_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "F2_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "G2_-1_1_1_Stitched[DAPI 377,447]_001.tif",
]
lower_vehicle_mean = df[df["FileName_images"].isin(lower_vehicle_wells)][
    "Count_nuclei"
].mean()

lower_dose1_wells = [
    "E3_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "F3_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "G3_-1_1_1_Stitched[DAPI 377,447]_001.tif",
]
lower_dose1_mean = df[df["FileName_images"].isin(lower_dose1_wells)][
    "Count_nuclei"
].mean()

lower_dose2_wells = [
    "E4_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "F4_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "G4_-1_1_1_Stitched[DAPI 377,447]_001.tif",
]
lower_dose2_mean = df[df["FileName_images"].isin(lower_dose2_wells)][
    "Count_nuclei"
].mean()

lower_dose3_wells = [
    "E5_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "F5_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "G5_-1_1_1_Stitched[DAPI 377,447]_001.tif",
]
lower_dose3_mean = df[df["FileName_images"].isin(lower_dose3_wells)][
    "Count_nuclei"
].mean()

lower_dose4_wells = [
    "E6_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "F6_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "G6_-1_1_1_Stitched[DAPI 377,447]_001.tif",
]
lower_dose4_mean = df[df["FileName_images"].isin(lower_dose4_wells)][
    "Count_nuclei"
].mean()

lower_dose5_wells = [
    "E7_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "F7_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "G7_-1_1_1_Stitched[DAPI 377,447]_001.tif",
]
lower_dose5_mean = df[df["FileName_images"].isin(lower_dose5_wells)][
    "Count_nuclei"
].mean()

lower_dose6_wells = [
    "E8_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "F8_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "G8_-1_1_1_Stitched[DAPI 377,447]_001.tif",
]
lower_dose6_mean = df[df["FileName_images"].isin(lower_dose6_wells)][
    "Count_nuclei"
].mean()

lower_dose7_wells = [
    "E9_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "F9_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "G9_-1_1_1_Stitched[DAPI 377,447]_001.tif",
]
lower_dose7_mean = df[df["FileName_images"].isin(lower_dose7_wells)][
    "Count_nuclei"
].mean()

lower_dose8_wells = [
    "E10_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "F10_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "G10_-1_1_1_Stitched[DAPI 377,447]_001.tif",
]
lower_dose8_mean = df[df["FileName_images"].isin(lower_dose8_wells)][
    "Count_nuclei"
].mean()

lower_dose9_wells = [
    "E11_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "F11_-1_1_1_Stitched[DAPI 377,447]_001.tif",
    "G11_-1_1_1_Stitched[DAPI 377,447]_001.tif",
]
lower_dose9_mean = df[df["FileName_images"].isin(lower_dose9_wells)][
    "Count_nuclei"
].mean()
...
normalized_upper_wells = [
    [
        df[df["FileName_images"] == well]["Count_nuclei"].mean() / upper_vehicle_mean
        for well in condition
    ]
    for condition in upper_conditions
]
normalized_lower_wells = [
    [
        df[df["FileName_images"] == well]["Count_nuclei"].mean() / lower_vehicle_mean
        for well in condition
    ]
...
def fivePL(
    x, A, B, C, D, G
):  # (x = doses, A = min y, B = Hill slope, C = inflection, D = max y, G = asymetry):
...
popt_5PL_y1, pcov_5PL_y1 = curve_fit(
    fivePL, x, y1, p0=params_init_5PL_y1, maxfev=int(1e4)
)
popt_5PL_y2, pcov_5PL_y2 = curve_fit(
    fivePL, x, y2, p0=params_init_5PL_y2, maxfev=int(1e4)
)
